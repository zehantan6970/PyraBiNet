...
def get_args_parser():
    ...
    parser.add_argument('--config', default='configs/pyrabinet/pyrabinet.py', type=str, help='config')

    # Model parameters
    parser.add_argument('--model', default='pyrabinet', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/home/zzw/PVT-v2/data/', type=str,
                        help='dataset path')
